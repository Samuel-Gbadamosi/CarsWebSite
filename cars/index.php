                ...
                <div class="row justify-content-around mt-4">
                    <div class="col-3   boche">
                        ...
                        <div class="row">
                            ...
                            <p class="text-secondary">kasd dolor no lorem nonunny sit labore tempor at justo rebum rebum stet,justo elitr dolor amet sit sea sed</p>
                    ...
                    <div class="col-3">
                        <div class="brod text-center">
                            ...
                            <div>
                                ...
                                <button class="btn-lg btn-warning" style="background-color: #D56A07; border: none; color: white; ">$99.00/Day</button>
                            </div>
                        </div>
                    ...
                    <div class="col-3">
                        <div class="brod text-center">
                            ...
                            <div>
                                ...
                                <button class="btn-lg btn-warning" style="background-color: #D56A07; border: none; color: white; ">$120.00/Day</button>
                            </div>
                        </div>
                    ...
                    <div class="col-3 offset-1">
                        <div class="brod text-center">
                            ...
                            <div>
                                ...
                                <button class="btn-lg btn-warning" style="background-color: #D56A07; border: none; color: white; ">$299.00/Day</button>
                            </div>
                        </div>
                    ...
                    <div class="row myc">
                        ...
                        <div class="col-7">
                            <div style="padding: 28px;">
                                ...
                                <button class="btn-lg btn-warning border border-0" style="background-color: #D56A07; border: none; color: white; ">Start Now</button>
                            </div>
                    ...
                    <div class="row myz">
                        ...
                        <div class=" col-7">
                            <div style="padding:28px;">
                                ...
                                <button class="btn-lg btn-warning" style="background-color: #D56A07; border: none; color: white;">Start Now</button>
                            </div>
